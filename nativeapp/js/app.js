	...
	try {
		...
		try {
			...
			*/
			...
			console.log('Failed to get task count from blockchain', e);
		}
	} catch(e) {
		console.log('Failed to get the account',e);
	}
...
async function removeTask(taskIndex) {
	...
	try {
		...
		console.log('Issue occured while removing task item-' + taskIndex,e);
	}
}
